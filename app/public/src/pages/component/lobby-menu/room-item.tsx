...
export default function RoomItem(props: {
  ...
  if (props.room.clients >= nbPlayersExpected) {
    ...
    props.room.metadata.blacklist.includes(uid)
  ) {
    canJoin = false
    ...
    !props.room.metadata.whitelist.includes(uid)
  ) {
    canJoin = false
    disabledReason = t("not_whitelisted")
  } else if (
    props.room.metadata?.minRank != null &&
    userElo < EloRankThreshold[props.room.metadata?.minRank]
  ) {
    canJoin = false
